...
from pytest_bdd_practice.lib.page_object_models.swag_labs_login_page import SwagLabsLoginPage
from pytest_bdd_practice.lib.page_object_models.swag_labs_products_page import SwagLabsProductsPage
